---
title: "Conventions, as of CNI spec v0.4.0"
...
There are three ways of passing information to plugins using the Container Network Interface (CNI), none of which require the [spec](https://github.com/containernetworking/cni/blob/master/SPEC.md) to be updated. These are 
